...
def train_model(rank,world_size,num_epochs=24):
    ...
    optimizer_ft = optim.SGD(model_ft.parameters(), lr=0.0005, momentum=0.9)#lr=0.001, momentum=0.9)

    # Decay LR by a factor of 0.1 every 7 epochs
    exp_lr_scheduler = lr_scheduler.StepLR(optimizer_ft, step_size=7, gamma=0.1)


    model_ft_ddp= DDP(model_ft,device_ids=[rank],output_device=rank,find_unused_parameters=True)
...
def demo_basic(rank, world_size):
    print(f"Running transfer learning DDP example on rank {rank}.")
